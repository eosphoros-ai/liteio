...
type SharedInformerFactory interface {
	...
	Volume() volumeantstoralipaycom.Interface
}

func (f *sharedInformerFactory) Volume() volumeantstoralipaycom.Interface {
	return volumeantstoralipaycom.New(f, f.namespace, f.tweakListOptions)
}
